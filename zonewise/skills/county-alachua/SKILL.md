...
name: county-alachua
description: >
  Zoning intelligence for Alachua County, FL (FDOR co_no: 1).
  ...
  overlay districts. Triggers on: Alachua County, co_no 1,
  any address in Alachua County Florida.
supabase_county_filter: "county=ilike.%25Alachua%25"
co_no: 1
portal_type: unknown
anti_scrape: false
rate_limit_rpm: 30
...
> **co_no**: 1 | **Phase**: P3 | **Anti-scrape**: false | **Rate limit**: 30 rpm
...
```python
queries = [
    "Alachua County Florida zoning ordinance municode",
    "Alachua County Florida GIS zoning layer ArcGIS",
    "Alachua County Florida online zoning map portal",
    "site:municode.com Alachua county florida zoning",
]
...
# Circuit breaker: 3 failures → INSERT insights(type='ESCALATE', meta={county:'alachua'})
```
...
- Fallback: FDOR fl_parcels table (co_no=1)

## Escalation Conditions

- 3 consecutive failures → `insights` table `type='ESCALATE'` + auto Traycer issue
- `last_validated > 30 days` → Traycer: `[SKILL] Revalidate county-alachua`
