...
name: county-calhoun
description: >
  Zoning intelligence for Calhoun County, FL (FDOR co_no: 7).
  ...
  overlay districts. Triggers on: Calhoun County, co_no 7,
  any address in Calhoun County Florida.
supabase_county_filter: "county=ilike.%25Calhoun%25"
co_no: 7
portal_type: unknown
anti_scrape: false
rate_limit_rpm: 30
...
> **co_no**: 7 | **Phase**: P3 | **Anti-scrape**: false | **Rate limit**: 30 rpm
...
```python
queries = [
    "Calhoun County Florida zoning ordinance municode",
    "Calhoun County Florida GIS zoning layer ArcGIS",
    "Calhoun County Florida online zoning map portal",
    "site:municode.com Calhoun county florida zoning",
]
...
# Circuit breaker: 3 failures → INSERT insights(type='ESCALATE', meta={county:'calhoun'})
```
...
- Fallback: FDOR fl_parcels table (co_no=7)

## Escalation Conditions

- 3 consecutive failures → `insights` table `type='ESCALATE'` + auto Traycer issue
- `last_validated > 30 days` → Traycer: `[SKILL] Revalidate county-calhoun`
