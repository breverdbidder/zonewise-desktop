...
name: county-citrus
description: >
  Zoning intelligence for Citrus County, FL (FDOR co_no: 9).
  ...
  overlay districts. Triggers on: Citrus County, co_no 9,
  any address in Citrus County Florida.
supabase_county_filter: "county=ilike.%25Citrus%25"
co_no: 9
portal_type: unknown
anti_scrape: false
rate_limit_rpm: 30
...
> **co_no**: 9 | **Phase**: P3 | **Anti-scrape**: false | **Rate limit**: 30 rpm
...
```python
queries = [
    "Citrus County Florida zoning ordinance municode",
    "Citrus County Florida GIS zoning layer ArcGIS",
    "Citrus County Florida online zoning map portal",
    "site:municode.com Citrus county florida zoning",
]
...
# Circuit breaker: 3 failures → INSERT insights(type='ESCALATE', meta={county:'citrus'})
```
...
- Fallback: FDOR fl_parcels table (co_no=9)

## Escalation Conditions

- 3 consecutive failures → `insights` table `type='ESCALATE'` + auto Traycer issue
- `last_validated > 30 days` → Traycer: `[SKILL] Revalidate county-citrus`
