...
description: >
  Zoning intelligence for Escambia County, FL (FDOR co_no: 17).
  ...
  overlay districts. Triggers on: Escambia County, co_no 17,
  any address in Escambia County Florida.
supabase_county_filter: "county=ilike.%25Escambia%25"
co_no: 17
portal_type: unknown
anti_scrape: false
rate_limit_rpm: 30
...
> **co_no**: 17 | **Phase**: P3 | **Anti-scrape**: false | **Rate limit**: 30 rpm
...
```python
queries = [
    "Escambia County Florida zoning ordinance municode",
    "Escambia County Florida GIS zoning layer ArcGIS",
    "Escambia County Florida online zoning map portal",
    "site:municode.com Escambia county florida zoning",
]
...
# Circuit breaker: 3 failures → INSERT insights(type='ESCALATE', meta={county:'escambia'})
```
...
- Fallback: FDOR fl_parcels table (co_no=17)

## Escalation Conditions

- 3 consecutive failures → `insights` table `type='ESCALATE'` + auto Traycer issue
- `last_validated > 30 days` → Traycer: `[SKILL] Revalidate county-escambia`
