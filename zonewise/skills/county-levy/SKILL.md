...
name: county-levy
description: >
  Zoning intelligence for Levy County, FL (FDOR co_no: 38).
  ...
  overlay districts. Triggers on: Levy County, co_no 38,
  any address in Levy County Florida.
supabase_county_filter: "county=ilike.%25Levy%25"
co_no: 38
portal_type: unknown
anti_scrape: false
rate_limit_rpm: 30
...
> **co_no**: 38 | **Phase**: P3 | **Anti-scrape**: false | **Rate limit**: 30 rpm
...
```python
queries = [
    "Levy County Florida zoning ordinance municode",
    "Levy County Florida GIS zoning layer ArcGIS",
    "Levy County Florida online zoning map portal",
    "site:municode.com Levy county florida zoning",
]
...
# Circuit breaker: 3 failures → INSERT insights(type='ESCALATE', meta={county:'levy'})
```
...
- Fallback: FDOR fl_parcels table (co_no=38)

## Escalation Conditions

- 3 consecutive failures → `insights` table `type='ESCALATE'` + auto Traycer issue
- `last_validated > 30 days` → Traycer: `[SKILL] Revalidate county-levy`
