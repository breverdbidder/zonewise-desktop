...
description: >
  Zoning intelligence for Okeechobee County, FL (FDOR co_no: 47).
  ...
  overlay districts. Triggers on: Okeechobee County, co_no 47,
  any address in Okeechobee County Florida.
supabase_county_filter: "county=ilike.%25Okeechobee%25"
co_no: 47
portal_type: unknown
anti_scrape: false
rate_limit_rpm: 30
...
> **co_no**: 47 | **Phase**: P3 | **Anti-scrape**: false | **Rate limit**: 30 rpm
...
```python
queries = [
    "Okeechobee County Florida zoning ordinance municode",
    "Okeechobee County Florida GIS zoning layer ArcGIS",
    "Okeechobee County Florida online zoning map portal",
    "site:municode.com Okeechobee county florida zoning",
]
...
# Circuit breaker: 3 failures → INSERT insights(type='ESCALATE', meta={county:'okeechobee'})
```
...
- Fallback: FDOR fl_parcels table (co_no=47)

## Escalation Conditions

- 3 consecutive failures → `insights` table `type='ESCALATE'` + auto Traycer issue
- `last_validated > 30 days` → Traycer: `[SKILL] Revalidate county-okeechobee`
