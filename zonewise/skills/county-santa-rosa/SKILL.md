...
description: >
  Zoning intelligence for Santa Rosa County, FL (FDOR co_no: 57).
  ...
  overlay districts. Triggers on: Santa Rosa County, co_no 57,
  any address in Santa Rosa County Florida.
supabase_county_filter: "county=ilike.%25Santa Rosa%25"
co_no: 57
portal_type: unknown
anti_scrape: false
rate_limit_rpm: 30
...
> **co_no**: 57 | **Phase**: P3 | **Anti-scrape**: false | **Rate limit**: 30 rpm
...
```python
queries = [
    "Santa Rosa County Florida zoning ordinance municode",
    "Santa Rosa County Florida GIS zoning layer ArcGIS",
    "Santa Rosa County Florida online zoning map portal",
    "site:municode.com Santa Rosa county florida zoning",
]
...
# Circuit breaker: 3 failures → INSERT insights(type='ESCALATE', meta={county:'santa-rosa'})
```
...
- Fallback: FDOR fl_parcels table (co_no=57)

## Escalation Conditions

- 3 consecutive failures → `insights` table `type='ESCALATE'` + auto Traycer issue
- `last_validated > 30 days` → Traycer: `[SKILL] Revalidate county-santa-rosa`
