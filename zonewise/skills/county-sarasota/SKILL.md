...
description: >
  Zoning intelligence for Sarasota County, FL (FDOR co_no: 58).
  ...
  overlay districts. Triggers on: Sarasota County, co_no 58,
  any address in Sarasota County Florida.
supabase_county_filter: "county=ilike.%25Sarasota%25"
co_no: 58
portal_type: unknown
anti_scrape: false
rate_limit_rpm: 30
...
> **co_no**: 58 | **Phase**: P3 | **Anti-scrape**: false | **Rate limit**: 30 rpm
...
```python
queries = [
    "Sarasota County Florida zoning ordinance municode",
    "Sarasota County Florida GIS zoning layer ArcGIS",
    "Sarasota County Florida online zoning map portal",
    "site:municode.com Sarasota county florida zoning",
]
...
# Circuit breaker: 3 failures → INSERT insights(type='ESCALATE', meta={county:'sarasota'})
```
...
- Fallback: FDOR fl_parcels table (co_no=58)

## Escalation Conditions

- 3 consecutive failures → `insights` table `type='ESCALATE'` + auto Traycer issue
- `last_validated > 30 days` → Traycer: `[SKILL] Revalidate county-sarasota`
