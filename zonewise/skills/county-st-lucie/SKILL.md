...
description: >
  Zoning intelligence for St. Lucie County, FL (FDOR co_no: 56).
  ...
  overlay districts. Triggers on: St. Lucie County, co_no 56,
  any address in St. Lucie County Florida.
supabase_county_filter: "county=ilike.%25St. Lucie%25"
co_no: 56
portal_type: unknown
anti_scrape: false
rate_limit_rpm: 30
...
> **co_no**: 56 | **Phase**: P3 | **Anti-scrape**: false | **Rate limit**: 30 rpm
...
```python
queries = [
    "St. Lucie County Florida zoning ordinance municode",
    "St. Lucie County Florida GIS zoning layer ArcGIS",
    "St. Lucie County Florida online zoning map portal",
    "site:municode.com St. Lucie county florida zoning",
]
...
# Circuit breaker: 3 failures → INSERT insights(type='ESCALATE', meta={county:'st-lucie'})
```
...
- Fallback: FDOR fl_parcels table (co_no=56)

## Escalation Conditions

- 3 consecutive failures → `insights` table `type='ESCALATE'` + auto Traycer issue
- `last_validated > 30 days` → Traycer: `[SKILL] Revalidate county-st-lucie`
