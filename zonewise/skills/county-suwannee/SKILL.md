...
description: >
  Zoning intelligence for Suwannee County, FL (FDOR co_no: 61).
  ...
  overlay districts. Triggers on: Suwannee County, co_no 61,
  any address in Suwannee County Florida.
supabase_county_filter: "county=ilike.%25Suwannee%25"
co_no: 61
portal_type: unknown
anti_scrape: false
rate_limit_rpm: 30
...
> **co_no**: 61 | **Phase**: P3 | **Anti-scrape**: false | **Rate limit**: 30 rpm
...
```python
queries = [
    "Suwannee County Florida zoning ordinance municode",
    "Suwannee County Florida GIS zoning layer ArcGIS",
    "Suwannee County Florida online zoning map portal",
    "site:municode.com Suwannee county florida zoning",
]
...
# Circuit breaker: 3 failures → INSERT insights(type='ESCALATE', meta={county:'suwannee'})
```
...
- Fallback: FDOR fl_parcels table (co_no=61)

## Escalation Conditions

- 3 consecutive failures → `insights` table `type='ESCALATE'` + auto Traycer issue
- `last_validated > 30 days` → Traycer: `[SKILL] Revalidate county-suwannee`
